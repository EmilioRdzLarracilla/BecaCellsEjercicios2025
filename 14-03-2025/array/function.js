...
const indiceEncontrado = buscarProducto("Mouse");
...
var seleccionados = nombres.slice(1,3);
...
document.addEventListener("DOMContentLoaded", function() {
    const datos = [
        ["Array.prototype.at", "const numeros = [1,2,3,4,5,6,7,8,9,0] => numeros.at(5)", 6],
        ["Array.prototype.concat", "[1,2,3,4,5,6],[papas,'cangrejo,'murcielago','sandia'], ['piedras','lago','rio']; => num.concat(palabras, cosas)", "[1,2,3,4,5,6,'papas','cangrejo','murciélago','sandía','piedras','lago','río']"],
        ["Array.prototype.copyWithin", "['papas','cangrejo','murcielago','sandia'].copyWithin(-1,-3,-1)", '["papas","cangrejo","murcielago","cangrejo"]'],
        ["Array.prototype.entries", "a= [1,2,3,4,5,6,7],iteracion = a.entries() => ", `Producto: "Mouse" encontrado en el índice 6`],
        ["Array.prototype.every", "(['uva', 'asdasda', 'melon'] => typeof element === 'string' && element !== '' ) ", true],
        ["Array.prototype.Filter", "celulares=['apple','samsung','oppo','realme','motorola','redmi']=> filtraritems('re')", '[ realme,redmi]'],
        ["Array.prototype.fill", "[0,1,2,3,9,7] => arr3.fill(3,4,5)", "[0,1,2,3,3,7]"],
        ["Array.prototype.find", "tienda.find(cosa => cosa.nombre === 'crema')", "{nombre: 'crema', cantidad: 5}"],
        ["Array.prototype.findIndex", "Array3.findIndex(numeromayor)", 2],
        ["Array.prototype.findLast", "list.findLast(encontrar)", "{nombre:'crema', cantidad: 25}"],
        ["Array.prototype.findLastIndex", "arr.findLastIndex(number)", 3],
        ["Array.prototype.flat", "nume.flat()", "[2, 6, 4, 8, 0, 5, 8, 9]"],
        ["Array.prototype.flatMap", "mul.flatMap((x) => [ x * 3])", "[6, 12, 18, 24, 15, 12, 9]"],
        ["Array.prototype.forEach", "arre.forEach((num, index) => {...})", "Iteración sobre cada elemento"],
        ["Array.prototype.includes", "mascota = ['pez', 'gato', 'perro','perico','zorro'] => mascota.includes('perico')", true],
        ["Array.prototype.indexOf", "array.indexOf(1)", "[0, 3, 5]"],
        ["Array.prototype.join", "avatar = ['aire','tierra','fuego','agua'] => join = avatar.join(',')", "'aire,tierra,fuego,agua'"],
        ["Array.prototype.keys", "clave.keys()", "Iterador de claves"],
        ["Array.prototype.lastIndexOf", "zoo.lastIndexOf('pato')", 2],
        ["Array.prototype.map", "ent.map(num => num / 2)", "[4,6,8,16,32]"],
        ["Array.prototype.pop", "autos.pop()", "Último elemento eliminado"],
        ["Array.prototype.push", "auto.push('BYD','Corvette')", 7],
        ["Array.prototype.reduce", "[0,5,9,3,4].reduce((prev, curr) => prev + curr, 1)", 22],
        ["Array.prototype.reduceRight", "[1,5,9,3,4].reduceRight((prev, curr) => prev + curr, 8)", 30],
        ["Array.prototype.reverse", "tareas.reverse()", "['barrer','trastes','aseo']"],
        ["Array.prototype.shift", "consultas.shift()", "Primer elemento eliminado"],
        ["Array.prototype.slice", "nombres = ['Jose', 'Pedro', 'Pablo', 'Ana', 'Veronica'] => nombres.slice(2,4)", "['Pablo', 'Ana']"],
        ["Array.prototype.some", "[2, 5, 8, 1, 4].some(mayorA)", false],
        ["Array.prototype.sort", "sort.sort((a,b) => a - b)", "[1,2,4,5,8]"],
        ["Array.prototype.splice", "libros.splice(3, 0, 'terror')", "['ficcion', 'comedia', 'drama', 'terror', 'suspenso']"],
        ["Array.prototype.toString", "astring.toString()", "'hola,tengo,24,años'"],
        ["Array.prototype.unshift", "uns.unshift('hola', 'me agregaron')", 5],
        ["Array.prototype.values", "ele.values()", "Iterador de valores"],
        ["Array.prototype.with", "est.with(1,2)", "[1, 2, 6, 4, 5]"]
    ];
    
    const tbody = document.querySelector("#tabla tbody");
    datos.forEach(dato => {
        const row = document.createElement("tr");
        dato.forEach(cellData => {
